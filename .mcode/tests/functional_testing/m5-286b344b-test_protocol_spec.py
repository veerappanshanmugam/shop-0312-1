...
Generated at: 2026-03-13T01:16:32.139194+00:00
Project: shop-0312-1
Milestone: 5
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "GET",
        "description": "Get sales report on empty database - should return zeros",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/reports/sales",
        "method": "GET",
        "description": "Seed a user, category, product, inventory, and order, then verify sales report reflects the order data",
        "setup": {
            "sequence": [
                {
                    "label": "user",
                ...
                },
                {
                    ...
                    "body": {
                        ...
                        "description": "For sales report test"
                    },
                    "extract_id_from": "id"
                },
                {
    ...
    },
    {
        ...
        "endpoint": "/reports/inventory",
        "method": "GET",
        "description": "Seed products and inventory, then verify inventory report with default low_stock_threshold of 10",
        "setup": {
            "sequence": [
                {
                    "label": "category",
                    ...
                    "method": "POST",
                    "body": {
                        "name": "Inventory Report Cat",
                        "description": "For inventory report test"
                    },
                    "extract_id_from": "id"
                },
                {
    ...
    },
    {
        ...
        "endpoint": "/reports/inventory",
        "method": "GET",
        "description": "Verify inventory report with custom low_stock_threshold query parameter",
        "setup": {
            "sequence": [
                {
                    "label": "category",
                    ...
                    "method": "POST",
                    "body": {
                        "name": "Threshold Test Cat",
                        "description": "For threshold test"
                    },
                    "extract_id_from": "id"
                },
                {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Get product performance report on empty database - should return empty list",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/reports/products",
        "method": "GET",
        "description": "Seed products with orders and verify product performance includes units_sold, revenue, and stock levels",
        "setup": {
            "sequence": [
                {
                    "label": "user",
                ...
                },
                {
                    ...
                    "method": "POST",
                    "body": {
                        "name": "Prod Perf Category",
                        "description": "For product perf test"
                    },
                    "extract_id_from": "id"
                },
                {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Get category performance report on empty database - should return empty list",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/reports/categories",
        "method": "GET",
        "description": "Seed categories with products and orders, verify category performance includes product_count, revenue, and units_sold",
        "setup": {
            "sequence": [
                {
                    "label": "user",
                ...
                },
                {
                    ...
                    "method": "POST",
                    "body": {
                        "name": "Cat Perf Category",
                        "description": "For category perf test"
                    },
                    "extract_id_from": "id"
                },
                {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Get user activity report on empty database - should return empty list",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "user_activity_with_data",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/users",
        "method": "GET",
        "description": "Seed users with orders and verify user activity includes total_orders and total_spent",
        "setup": {
            "sequence": [
                {
                    "label": "user",
                ...
                },
                {
                    ...
                    "method": "POST",
                    "body": {
                        "name": "Activity Test Cat",
                        "description": "For user activity test"
                    },
                    "extract_id_from": "id"
                },
                {
