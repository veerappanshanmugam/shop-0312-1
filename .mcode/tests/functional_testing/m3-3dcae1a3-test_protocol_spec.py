...
Generated at: 2026-03-13T01:16:03.570178+00:00
Project: shop-0312-1
Milestone: 3
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "setup": {
            ...
            "body": {
                ...
                "description": "Product for inventory retrieval test",
                "price": 29.99
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "PUT",
        "description": "Create a product, then update its inventory quantity to 50",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Inventory Update Product",
                "description": "Product for inventory update test",
                "price": 19.99
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "PUT",
        "description": "Attempt to update inventory for a non-existent product ID",
        "request_data": {
            "path": {
                "product_id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}/reserve",
        "method": "POST",
        "description": "Create a product (inventory defaults to 0), then attempt to reserve units exceeding available stock",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Insufficient Stock Product",
                "description": "Product for insufficient inventory test",
                "price": 39.99
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}/reserve",
        "method": "POST",
        "description": "Attempt to reserve inventory for a non-existent product ID",
        "request_data": {
            "path": {
                "product_id": 999999
            },
