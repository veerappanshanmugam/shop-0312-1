...
Generated at: 2026-03-19T03:24:02.537982+00:00
Project: shop-0317-1
Milestone: 2
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "List all categories after creating one",
        "endpoint": "/categories",
        "method": "GET",
        "setup": {
            "endpoint": "/categories",
    ...
    },
    {
        ...
        "actual_response": {
            "price": "999.99",
            "id": 1,
            "created_at": "2026-03-19T02:55:51.804400",
            "description": "A powerful laptop",
            "category_id": null,
            "name": "Laptop"
        }
    },
    {
        ...
        "category": "NOT_FOUND",
        "description": "Attempt to create a product with a non-existent category ID",
        "endpoint": "/products",
        "method": "POST",
        "request_data": {
            "body": {
    ...
    },
    {
        ...
        "actual_response": {
            "price": "29.99",
            "id": 2,
            "created_at": "2026-03-19T02:55:51.814631",
            "description": null,
            "category_id": null,
            "name": "GetTestProduct"
        }
    },
    {
        ...
        "category": "NOT_FOUND",
        "description": "Attempt to retrieve a non-existent product",
        "endpoint": "/products/{product_id}",
        "method": "GET",
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "List all products after creating one",
        "endpoint": "/products",
        "method": "GET",
        "setup": {
            "endpoint": "/products",
        ...
        "actual_response": [
            ...
            },
            {
                "price": "19.99",
                "id": 3,
                "created_at": "2026-03-19T02:55:51.820471",
                "description": null,
                "category_id": null,
                "name": "ListTestProduct"
            }
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Get inventory for a product (auto-created with quantity 0 on product creation)",
        ...
        "actual_response": {
            "last_updated": "2026-03-19T02:55:51.826916",
            "product_id": 4,
            "quantity": 0,
            "reserved": 0
        }
    ...
    },
    {
        ...
        "actual_response": {
            "last_updated": "2026-03-19T02:55:51.839206",
            "product_id": 5,
            "quantity": 50,
            "reserved": 0
        }
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Attempt to reserve more inventory than available",
        ...
        "setup": {
            ...
            "method": "POST",
            "body": {
                "name": "ReserveInsufficientProduct",
                "price": 10.0
            },
            "extract_id_from": "id"
        },
        ...
        "expected_status": 400,
        "actual_response": {
            "detail": "Insufficient inventory. Available: 0, Requested: 5"
        }
    },
    {
