...
Generated at: 2026-03-13T01:16:02.247363+00:00
Project: shop-0312-1
Milestone: 4
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    {
        "name": "create_order_missing_required_fields",
        "category": "MISSING_REQUIRED",
        "endpoint": "/orders",
        "method": "POST",
        "description": "Send an empty body to create order, expect 422 validation error.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/orders",
        "method": "GET",
        "description": "List all orders. Returns an array (possibly empty on a fresh database).",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "create_order_invalid_type_user_id",
        "category": "INVALID_TYPE",
        "endpoint": "/orders",
        "method": "POST",
        "description": "Send a string as user_id instead of integer, expect 422 validation error.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
